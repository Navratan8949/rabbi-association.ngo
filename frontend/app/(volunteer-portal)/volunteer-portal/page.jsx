  ...
  useEffect(() => {
    async function fetchDashboardData() {
      try {
        setLoading(true);
        try {
          const memberRes = await api.get("/volunteer/me");
          setVolunteer(memberRes.data?.volunteer);
        } catch (e) {}
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-base text-white/80 font-medium leading-relaxed">
              Track your NGO volunteering, donations, registered events, and
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <h2 className="text-2xl font-bold text-navy flex items-center gap-3">
              <UserCheck className="size-6 text-accent" /> Volunteer Status
              Tracker
            </h2>
            <p className="mt-1 text-sm font-medium text-muted-foreground">
              Monitor the progress of your official volunteer application in
              real-time.
            </p>
          </div>
          {!volunteer && (
            ...
            >
              <Link href="/volunteer">
                Apply for Volunteering <ArrowRight className="ml-2 size-4" />
              </Link>
            </Button>
          )}
        </div>
            ...
            >
              ...
              <p
                className={cn(
                  ...
                  volunteer ? "text-navy" : "text-slate-600",
                )}
              >
                {volunteer ? "Submitted" : "Not Applied"}
              </p>
              ...
              <p className="text-xs text-muted-foreground mt-1 font-medium">
                {isApproved
                  ...
                  : isPending
                    ...
                    : isRejected
                      ? volunteer?.rejectionReason || "Check profile"
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-8 lg:col-span-1">
          ...
          <div className="overflow-hidden rounded-[2rem] border border-border/50 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            ...
            <div className="px-6 pb-6 relative">
              <div className="absolute -top-12 left-6 rounded-[1.25rem] bg-white p-1.5 shadow-md">
                <div className="flex size-20 items-center justify-center overflow-hidden rounded-[1rem] bg-navy text-2xl font-bold text-white shrink-0">
                  {volunteer?.profileImage?.url ? (
                    <img
                      src={volunteer.profileImage.url}
                      alt="Profile"
              ...
              >
                <Link href="/volunteer-portal/profile">View Profile Details</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="rounded-[2rem] border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50/30 p-6 shadow-sm">
            ...
            <p className="text-blue-700/80 mt-1 text-sm">
              ...
              verified Volunteer QR Card for upcoming NGO events.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          <div className="grid gap-6 sm:grid-cols-2">
            {/* Donations Card */}
            <Link
              href="/volunteer-portal/donations"
